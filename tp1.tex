...
\begin{enumerate}
    ...
    \begin{center}
        ...
        Maximizar 5.900 x1 + 2.900 x2 + 1.200 x3
    ...
    Entonces el dual queda de la siguiente manera: \\

    Función objetivo: 

    \begin{center}
        
        Maximizar 38.000 y1 + 80.000 y2 + 1.000 y3 + 3.000 y4 + 7.000 y5
    ...
    \begin{itemize}
        ...
        \item 10 y1 + 20 y2 + y3 $\geq$ 5.900
        \item 5 y1 + 10 y2 + y4 $\geq$ 2.900
        \item 3 y1 + 6 y2 + y5 $\geq$ 1.200
        \item Condiciones de no negatividad: y1 $\geq$ 0, y2 $\geq$ 0, y3 $\geq$ 0, y4 $\geq$ 0, y5 $\geq$ 0\\
    ...
    Luego, observando que y1 = 400, eso quiere decir que la propuesta va a ser rentable siempre que se pague, hasta como mucho, \$400 por cada hora extra del sector. \\
